...
/**
 * ⚙️ Icono de doble chevron para ser usado como separador en los breadcrumbs.
 * Reemplaza al ícono de un solo chevron para un estilo visual más distintivo.
 */
export const DoubleChevronRightIcon: React.FC<{ className?: string }> = (props) => (
  <svg
    fill="currentColor"
